module RDF::N3::Algebra::Math
  ...
  class Tan < SPARQL::Algebra::Operator::Binary
    ...
    ##
    # The math:tan operator takes string or number and calculates its tangent.
    #
    ...
    def execute(queryable, solutions:, **options)
      ...
      @solutions = RDF::Query::Solutions(solutions.map do |solution|
        ...
        num = RDF::Literal(Math.tan(num.as_number.object))
